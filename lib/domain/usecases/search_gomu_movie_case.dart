...
class SearchGomuMovieCase {
  final GomuflixMoviesRemoteEntities remoteEntities;
  SearchGomuMovieCase(this.remoteEntities);

  Future<Either<FailureCondition, List<GomuflixMovieEntity>>> execute(query) {
    return remoteEntities.searchGomuflixMovies(query);
  }
}
